...
WinScreen::WinScreen(Engine *pEngine) {
  this->backgroundTexture.loadFromFile("assets/imgs/win.png");
...
void WinScreen::update(Engine *pEngine) {}

void WinScreen::render(sf::RenderWindow *pWindow) {
  pWindow->setView(
